...
do
    ...
    tft_ts.init(0,8,3,1,4,nil,0) -- default pins : cs=0, dc=8, cs=3, irq=1, led = 4
    ...
    App.mqtt = {
        ...
        --user = "fredthx",
        --pass = "GaZoBu",
        client_name = "NODE-PID-ECRAN",
        base_topic = "T-HOME/PID/ECRAN/"
    }
...
--                    end}
    ...
    App.mqtt_in_topics[App.mqtt.base_topic.."CMD"] = {
            ...
            ["WAKE"]=function()
                        tft_ts.init_screen_saver(300000)
                    end
            }
