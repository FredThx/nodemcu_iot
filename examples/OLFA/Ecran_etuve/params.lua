...
do
    ...
    tft_ts.init(0,8,3,1,4,nil,270) -- default pins : cs=0, dc=8, cs=3, irq=1, led = 4
    ...
    App.mqtt = {
        ...
        --user = "fredthx",
        --pass = "GaZoBu",
        client_name = "ETUVE-TFT",
        base_topic = "OLFA/PEINTURE/ECRAN_ETUVES/"
    }
    ...
    App.mqtt_in_topics[App.mqtt.base_topic.."WAKEUP"] =
                function(data)
                    pcall(tft_ts.init_screen_saver, tonumber(data) * 1000)
                end
